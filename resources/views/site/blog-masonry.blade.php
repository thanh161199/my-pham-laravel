...
@section('main')
<!--title page-->
<div class="title-page" style="background-image: url('file/imager/blog/blog-title.jpg');background-position: center center;background-size: cover;">
  <div class="container">
    <div class="row">
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you.</p>
          </div>
          <div class="card-body">
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized.</p>
          </div>
          <div class="card-body">
            <span>20Th October 2019</span>
            <a href="javascrip:void(0)" class="card-link share">Share
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden.</p>
          </div>
          <div class="card-body">
            <span>20Th October 2019</span>
            <a href="javascrip:void(0)" class="card-link share">Share
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate.</p>
          </div>
          <div class="card-body">
            <span>20Th October 2019</span>
            <a href="javascrip:void(0)" class="card-link share">Share
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin.</p>
          </div>
          <div class="card-body">
            <span>20Th October 2019</span>
            <a href="javascrip:void(0)" class="card-link share">Share
